...
public class UmlCopyAndFilter2 implements Runnable {
    ...
    public UmlCopyAndFilter2(final Path transformationModel, final Path umlSourcePath, final Path umlTargetPath) {
